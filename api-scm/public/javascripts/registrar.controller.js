...
(function () {
    ...
    RegistrarController.$inject = ['FormularioService', 'Provider', 'sharedList', 'ListFactory', 'ShoppingListService', '$rootScope'];
    function RegistrarController(FormularioService, Provider, sharedList, ListFactory, ShoppingListService, $rootScope) {
